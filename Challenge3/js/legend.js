    ...
    function legend(g) {
        ...
        function redraw() {
            ...
            if (orientation == "vertical") {
                ...
                g.selectAll("text.breakLabels").style("text-anchor", "middle").attr("x", 30).attr("y", -13).style("display", function(d,i) {return "block"}).text(function(d) {return labelFormat(d.stop[0])});
            }
        }
        ...
        console.log("LegendText1" + legenTexts[1]) ;
        redraw();
    }
